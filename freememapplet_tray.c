...
void tray_icon_on_menu(GtkStatusIcon *status_icon, guint button, guint activate_time, gpointer user_data)
{
	...
	if (pupSavefile) 
	{
		menuitem = gtk_menu_item_new_with_label(RESIZE);
...
static GtkStatusIcon *create_tray_icon() {
	...
	grey_pixbuf = gdk_pixbuf_new_from_file(g_build_filename(ICON_PATH, "container_0.svg", NULL),&gerror);
    critical_pixbuf = gdk_pixbuf_new_from_file(g_build_filename(ICON_PATH, "container_1.svg", NULL),&gerror);
    ok_pixbuf = gdk_pixbuf_new_from_file(g_build_filename(ICON_PATH, "container_2.svg", NULL),&gerror);
    good_pixbuf = gdk_pixbuf_new_from_file(g_build_filename(ICON_PATH, "container_3.svg", NULL),&gerror);
    excellent_pixbuf = gdk_pixbuf_new_from_file(g_build_filename(ICON_PATH, "container_4.svg", NULL),&gerror);
